...
plotNormal <- function(repitions, mean, sd){
  data <- rnorm(repitions, mean, sd)
  hist(data, main = "Histogram of Random Normal Numbers", xlab = "Numbers")
}
plotNormal(1000, 0, 1)
...
plotNormal <- function(repitions, mean, sd, color){
  data <- rnorm(repitions, mean, sd)
  hist(data, main = paste("Histogram from a Normal(", mean, ",", sd, ") Distribution"), xlab = "Numbers", col = color)
}
plotNormal(1000, 0, 1, "green")
